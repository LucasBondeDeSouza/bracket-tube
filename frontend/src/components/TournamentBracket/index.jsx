    ...
    return (
        <>
            <div className="flex flex-col md:flex-row w-full md:gap-3 gap-5 items-center justify-center relative md:px-10 cursor-pointer">
                {/* Vídeo 1 */}
                {match.home && (
                    <div className={`flex flex-col gap-2 w-full md:w-1/2 h-[250px] md:h-[350px] 2xl:h-[550px] hover:scale-105 transition ${getWinnerClass(match.home)} ${getLoserClass(match.home)} ${getBothClass()}`}>
                        <iframe
                ...
                {/* Vídeo 2 */}
                {match.away && (
                    <div className={`flex flex-col gap-2 w-full md:w-1/2 h-[250px] md:h-[350px] 2xl:h-[550px] hover:scale-105 transition ${getWinnerClass(match.away)} ${getLoserClass(match.away)} ${getBothClass()}`}>
                        <iframe
                            className="w-full h-full rounded-2xl"
